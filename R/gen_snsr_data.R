...
gen_snsr_data = function(snsr.name, traj, timing, snsr.mdl=NULL, g=NULL, clean_data = FALSE) {
  ...
  if (snsr.name == "baro") {
    ...
    XV_NED = t(cbind(traj$trajectory$x_N,
                     traj$trajectory$x_E,
                     traj$trajectory$x_D,
                     traj$trajectory$v_N,
                     traj$trajectory$v_E,
    ...
    V_NED = t(cbind(traj$trajectory$v_N,
                    traj$trajectory$v_E,
                    traj$trajectory$v_D))
    rpy   = t(cbind(traj$trajectory$roll,
