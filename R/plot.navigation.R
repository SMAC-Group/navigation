...
plot.navigation =  function(x, true_col = "#2980b9", col_fused_trans = "#EA5D0073", col_fused_full  = "#EA5D00FF",
                            plot_mean_traj = TRUE, plot_baro = TRUE, baro_col = 'black', emu_to_plot = 1,
                            plot3d = TRUE, plot_CI = FALSE, time_interval = 5,
                            col_50 ="#E74C3C4D", col_95 = "#F5B0414D", col_50_brd ="#E74C3C", col_95_brd = "#F5B041",
                            error_analysis = TRUE, emu_for_covmat = 1, nsim = 1000, col_traj_error = "#1C12F54D",time_interval_simu = .5, ...){
  ...
  lines(traj$x_E, traj$x_N, col = true_col, type = "l",
        xlab= "Local - East - Coord.",
        ylab = "Local - North - Coord.", xlim = range_x,
        ylim = range_y, lwd = 3, main ='North-East coordinates')
  ...
  if(plot_CI == TRUE){
    legend('bottomright',
           ...
           legend= c('True trajectory', 'Emulated trajectories',
  ...
  #Empty plot
  plot(traj$time, -traj$x_D, col = 'white', type = "l",
  ...
  lines(traj$time, -traj$x_D, col = true_col, type = "l",
        xlab= "Time (sec)", lwd = 2.5,
        ylab = "Local - Up - Coord.", ylim = range_z, main = 'Up coordinates')
  ...
  if(plot3d == T){
    ...
    #add true trajectory
    p = p %>% add_trace(x = ~x_E, y = ~x_N, z = ~-x_D, type = 'scatter3d',
    ...
    p = p %>% add_markers(x = ~x_E, y = ~x_N, z = ~z,
...
# plot(x, time_interval_simu = 1)
# true_col = "#2980b9"; col_fused_trans = "#EA5D0073"; col_fused_full  = "#EA5D00FF";
# plot_mean_traj = TRUE; plot_baro = TRUE; baro_col = 'black'; emu_to_plot = 1;
# plot3d = TRUE; plot_CI = TRUE; time_interval = 5;
# col_50 ="#E74C3C4D"; col_95 = "#F5B0414D"; col_50_brd ="#E74C3C"; col_95_brd = "#F5B041";
# error_analysis = TRUE; emu_for_covmat = 1; nsim = 1000; col_traj_error = "#1C12F54D"
