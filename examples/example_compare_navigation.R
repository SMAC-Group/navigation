...
# here we configure the EKF to have the same model as for data generation (ideal setup)
KF.mdl = list()
...
# here we configure a wrong model wrt to data generation (only composed of the white noise part)
