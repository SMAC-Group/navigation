...
- idx:
  ...
  Components of the states to be considered (default: position and
  orientation)

- progressbar:

  A `boolean` specifying whether or not to show a progress bar. Default
  is FALSE.

## Value

Return a `coverage.stat` object which contains the empirical coverage of
