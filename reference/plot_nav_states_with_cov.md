...
this function plots the navigation states with estimated covariance of a
solution computed with the `navigation` function
...
- error:
  ...
  Wether to plot the error with respect to the refefence or the
  estimated values
